...
_LOCAL_TABS = {
    ...
    "Documentos_Cargados": ["id","fecha_importacion","nombre_archivo","banco","cuenta",
                            "tipo_cuenta","moneda","periodo","fecha_desde","fecha_hasta",
                            "num_transacciones","total_gastos","total_ingresos","estado","notas"],
}
